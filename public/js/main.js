  ...
  $(document).ready(function () {
    ...
    if (pThumbanilSlider.length) {
      pThumbanilSlider.slick({
        ...
        arrows: false,
        prevArrow:
          '<div class="slick-prev"><i class="fa fa-angle-double-up"></i></div>',
        nextArrow:
          '<div class="slick-next"><i class="fa fa-angle-double-down"></i></div>',
      });
    }
    ...
    $(document).on("mouseover", ".single-intro-contact-wrap", function () {
      ...
      $(".single-intro-contact-wrap").removeClass(
        "single-intro-contact-wrap-active"
      );
      $(this).addClass("single-intro-contact-wrap-active");
    });
